                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all font-sans"
                            />
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all pr-12 font-sans"
                                />
                                <button type="button" onClick={() => setShowPwd(!showPwd)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--muted)]">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-primary-500 hover:bg-primary-600 text-white font-semibold transition-all disabled:opacity-70 shadow-lg shadow-primary-500/30"
                        >
                            {loading ? "..." : "Sign In"}
                        </button>
                    </form>
